...
module.exports.createPages = async ({ graphql, actions }) => {
  ...
  `)
    ...
    const data2 = dataPage2.data.prismic.allPages.edges
    const dataPageFull = data1.map((item , i) => Object.assign({},item.id,data2[i]))
    dataPageFull.forEach((edge) => {
    createPage({
