...
export default function Interested({ dataFooter }) {
  ...
  const dataBTG = dataFooter ? dataFooter?.edges[0]?.node?.body?.filter(item => item?.type ? item?.type === "cta": "") : [];
  const dataBGR = dataBTG[0] && dataBTG[0]?.primary?.background_color_cta_block ? dataBTG[0]?.primary?.background_color_cta_block : [];
  const dataInterested = dataBTG[0]?.primary?.subtitle[0]?.text &&  dataBTG[0]?.primary?.subtitle[0]?.text ? dataBTG[0]?.primary?.subtitle[0]?.text : "";
  const dataInterestedTitle = dataBTG[0]?.primary?.title[0]?.text && dataBTG[0]?.primary?.title[0]?.text ? dataBTG[0]?.primary?.title[0]?.text  : "";
